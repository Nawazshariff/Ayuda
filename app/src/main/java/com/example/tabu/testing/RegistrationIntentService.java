...
/**
 * Created by nawazshariff on 06-07-2016.
 */
...
//            postData(params[0]);
            Log.d("RegistrationService","1st"+params[0]);
            test(params[0]);
            return null;
        }
        ...
        protected void onPostExecute(Double result){
            ...
            Toast.makeText(getApplicationContext(), "token sent to database", Toast.LENGTH_LONG).show();
    ...
    public void test(String value){
        ...
        String Response="";
        Log.d("RegistrationService",value);
        URL url;
        try {
            url = new URL("http://nawaznowman.net16.net/sendtoken.php");
            ...
            Uri.Builder builder = new Uri.Builder()
                    .appendQueryParameter("token",value);
